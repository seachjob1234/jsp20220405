...
<script>
	$(document).ready(function() {
		...
		//reply -edit -toggle 버튼클릭시 댓글 보여주는 div 숨기고,
		//수정 form 보여주기
							...
							<div id="replyEditFormContainer${reply.id}" style = "display: none;">
								...
								<form action="${appRoot }/reply/modify" method = "post">
									<div class="input-group">
										...
										<button class="btn btn-outline-secondary"><i class="fa-solid fa-comment-dots"></i>
										</button>
									</div>
								</form>
							</div>
